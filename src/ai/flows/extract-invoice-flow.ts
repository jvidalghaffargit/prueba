...
const ExtractInvoiceOutputSchema = z.object({
    ...
    baseAmount: z.number().describe("The base amount (subtotal) of the invoice, BEFORE any taxes are applied."),
    totalAmount: z.number().describe("The final, total amount due on the invoice, AFTER taxes."),
...
- **Base Amount (Subtotal): CRITICAL. The total amount BEFORE taxes.**
- **Total Amount: The final, total amount to be paid.**
